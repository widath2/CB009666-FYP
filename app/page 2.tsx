        ...
        <div className="rounded-3xl bg-white/90 backdrop-blur shadow-2xl overflow-hidden animate-fade-in">
          ...
          {currentStep === "upload" && (
            <div className="p-10">
              ...
              <p className="mb-8 text-lg text-gray-600 font-medium">
                Take a photo or upload an image of any text you want to read
              </p>
              <FileUpload
            ...
            <div className="p-10">
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="mt-3 text-lg text-gray-600 font-medium">
                  Using AI to extract text from your image
                </p>
              </div>
            </div>
          )}
          ...
          {currentStep === "simplify" && extractedText && (
            <div className="p-10">
              ...
              <p className="mb-8 text-lg text-gray-600 font-medium">
                We found this text in your image
              </p>
          ...
          {currentStep === "listen" && simplifiedText && (
            <div className="p-10">
              ...
              <div className="mb-8">
                ...
                <div className="dyslexia-friendly dyslexia-bg rounded-2xl p-8 shadow-inner">
